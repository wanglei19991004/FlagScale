...
class Compose:
    ...
    def __init__(self, callables: List[Callable], name: str = None):
    ...
    def __call__(self, *args, **kwargs) -> Any:
        ...
        for callable_obj in self.callables[1:]:
            try:
                ...
                logger.warning(f"Error in compose chain at {callable_obj}: {e}")
                raise
    ...
    def __repr__(self) -> str:
        ...
        callable_names = [getattr(c, "__name__", type(c).__name__) for c in self.callables]
