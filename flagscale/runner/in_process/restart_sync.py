...
class RestartCoordinator:
    ...
    def request_restart(
        self, attempt: int, rank: int, reason: str, initial_rank: int = -1, iteration: int = 0
    ) -> bool:
    ...
    def barrier(self, name: str, attempt: int, timeout_s: float = None) -> bool:
...
def create_restart_coordinator(
    rank: int = None, world_size: int = None, **kwargs
